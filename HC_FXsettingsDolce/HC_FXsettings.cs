...
{
    [BepInPlugin("HC_FXsettings", "HC_FXsettings", "1.2.0")]
    public class FXsettings : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            AnamorphicFlaresNearAtten = Config.Bind("Bloom and flares", "Anamorphic flares near attenuation", 0f, new ConfigDescription("Set anamorphic flares near attenuation", new AcceptableValueRange<float>(-10f, 10f)));
            ...
            Blue = Config.Bind("Color", "RGB (G)", 1f, new ConfigDescription("Set blue", new AcceptableValueRange<float>(0f, 1f)));
    ...
    public class FXcomponent : MonoBehaviour
    {
        public static class Hooks
        {
            ...
            public static void GetBeautifyHook(VolumeCtrl __instance, Beautify.Universal.Beautify __result)
            {
                ...
                if (__instance.nowVolumeInfo.Beautify != null && __result != null)
                {
                    FXsettings.beautifyInstance = __instance.nowVolumeInfo.Beautify;
                    FXsettings.ApplySettings();
                    FXsettings.postProcessCamera = Camera.main;
